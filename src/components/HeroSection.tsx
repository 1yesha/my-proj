  ...
  return (
    <div className="h-auto md:h-[40rem] w-full bg-black rounded-md flex flex-col items-center justify-center
     ...
     <div className='p-4 relative z-10 w-full text-center'>
        ...
        <p className='mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto'>Dive into our comprehensive 
            coding courses and transform your development journey today.
